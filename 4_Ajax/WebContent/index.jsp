		...
		$('#userInfoBtn').click(function(){
			$.ajax({
				...
				success: function(data){
					...
					// 제이쿼리를 이용한 값을 담는 변수이기 때문에 앞에 $ 붙음
					$tableBody.html(""); 
					// 클릭할 때 마다 밑으로 계속 추가되는 것을 방지하기 위해 붙어 있는 td들 지우고 새로 붙이는 작업
